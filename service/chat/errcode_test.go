...
var codedSentinels = map[int32]error{
	CodeChannelInvalid:   ErrChannelInvalid,
	CodeSenderInvalid:    ErrSenderInvalid,
	CodeMessageInvalid:   ErrMessageInvalid,
	CodeTypeUnknown:      ErrTypeUnknown,
	CodeNotPermitted:     ErrNotPermitted,
	CodeRequestInvalid:   ErrRequestInvalid,
	CodeCursorInvalid:    ErrCursorInvalid,
	CodeRangeInvalid:     ErrRangeInvalid,
	CodeSystemDenied:     ErrSystemDenied,
	CodeAlreadyPublished: ErrAlreadyPublished,
