...
var codedSentinels = map[int32]error{
	CodeIdentityInvalid: ErrIdentityInvalid,
	CodeIdentityDenied:  ErrIdentityDenied,
	CodeAccountMissing:  ErrAccountMissing,
	CodeServerInvalid:   ErrServerInvalid,
	CodeServerClosed:    ErrServerClosed,
	CodeNameInvalid:     ErrNameInvalid,
	CodeNameTaken:       ErrNameTaken,
	CodeRoleLimit:       ErrRoleLimit,
	CodeRoleMissing:     ErrRoleMissing,
	CodeNotPermitted:    ErrNotPermitted,
	CodeSessionInvalid:  ErrSessionInvalid,
